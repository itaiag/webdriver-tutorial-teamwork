...
public class AddTaskTests {
	...
	public void testAddTask() {
		...
		driver.findElement(By.xpath("//li[@id='tab_tasks']/a")).click();

		// Add task list
		wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("//li[@id='tab_tasks' and @class='first sel']")));
		driver.findElement(By.xpath("//li[@id='liBFOATL']/button")).click();
		...
		driver.findElement(By.xpath("//button[@onclick='TaskLists.AddTaskFromTasklistPage();']")).click();

		final String taskName = "My Task " + System.currentTimeMillis();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='twitter-typeahead']//input[@placeholder='What needs to be done?']"))).sendKeys(taskName);
		driver.findElement(By.xpath("//input[@value='Save my changes']")).click();
